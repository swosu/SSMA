# -*- coding: utf-8 -*-
"""
Created on Tue Jun 14 08:19:10 2022
...
if ans1 in answer_yes:
    ...
    if ans2 in answer_yes:
        print("\nYou are an honest person. He was a thief & now he's in jail, You won the Game")

    elif ans2 in answer_no:
        print("\nYou helped a thief, why?. Now, go to Jail. GAME OVER")
    ...
    if ans3 in answer_yes:
        ...
        print("\nSorry! You are dead. He was a thief & He killed you, there was an attempt made. GAME OVER")
